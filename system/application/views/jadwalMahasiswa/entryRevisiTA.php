...
<div id="entry_sidangproposal">  
    <form id="form-revisi" method="post" action="<?php echo base_url(); ?>index.php/jadwalMahasiswa/updateRevisiTA">
        <div class='detail'>
        <input type="hidden" name="id_proposal" value="<?php echo $proposal->ID_PROPOSAL; ?>">
        <input type="hidden" name="id_jdw_mhs" value="<?php echo $proposal->ID_JDW_MHS; ?>">
        ...
        <div class='detail'>
            ...
            <div class='element wide' style='margin:1em; text-align:right'>
                ...
                <input type='submit' value='Simpan' style='width: 150px' onclick="document.forms["form-revisi"].submit();" />
            </div>
        </div>
    </form>
</div>