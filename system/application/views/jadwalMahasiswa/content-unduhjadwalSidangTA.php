        ...
        if(!empty($list_proposal)) {
            ...
            <div class=Section1>";
				...
				<tr><td>NOMOR POKOK</td><td>:</td><td>$prop->NRP</td></tr>
				<tr><td style=\"vertical-align:top\">JUDUL</td><td>:</td><td>$prop->JUDUL_TA</td></tr>
				<tr><td>Adalah</td><td>:</td></tr>
				<tr><td colspan=\"3\" align=\"center\"><table cellspacing=\"0\"><tr><td width=\"150\" height=\"75\" style=\"border:solid;border-width:thick;vertical-align:middle\" align=\"center\"><h3>Nilai huruf :</h3></td><td width=\"100\" height=\"75\" style=\"border:solid;border-width:thick\">&nbsp;</td></tr></table></td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td>Catatan :</td></tr>
				...
				if($prop->NAMA_PEMBIMBING2!="--"){
					...
					<tr><td>RUANG</td><td>:</td><td>$prop->DESKRIPSI</td></tr>
					<tr><td colspan =\"3\">Adalah sebagai berikut</td></tr>
					<tr><td>&nbsp;</td></tr>
					<tr><td colspan=\"3\">
						<table border=\"1\" align=\"center\" >
							<tr>
								<td>UNSUR</td><td>SASARAN PENILAIAN</td>
							</tr>
							<tr>
								<td>A</td><td>MATERI TUGAS AKHIR<br>(Tingkat kesulitan, Analisa, Obyektifitas, Kelengkapan Laporan)</td></tr>
							<tr>
								<td>B</td><td>PENGUASAAN MATERI<br>(Ketepatan Menjawab Pertanyaan)</td>
							</tr>
							<tr>
								<td>C</td><td>KEMAMPUAN PRESENTASI<br>(Komunikasi, Pengendalian Waktu, Penyajian, Kejujuran)</td>
							</tr>
							<tr>
								<td>D</td><td>TATA TULIS BUKU TUGAS AKHIR<br>(Format, Typo, Referensi, Tabel/Gambar, Kelengkapan)</td>
							</tr>
						</table>
					</td></tr>
					<tr><td colspan=\"3\" align=\"center\"><table cellspacing=\"0\"><tr><td width=\"150\" height=\"75\" style=\"border:solid;border-width:thick;vertical-align:middle\" align=\"center\"><h3>Nilai huruf :</h3></td><td width=\"100\" height=\"75\" style=\"border:solid;border-width:thick\">&nbsp;</td></tr></table></td></tr>
					...
					if($prop->PENGUJI2!="--"){
						...
						<tr><td colspan=\"3\">
							<table border=\"1\" align=\"center\" >
								<tr><td>No.</td><td>SASARAN PENILAIAN</td></tr>
								<tr><td>1</td><td>MATERI TUGAS AKHIR<br>(Tingkat kesulitan, Analisa, Obyektifitas, Kelengkapan Laporan)</td></tr>
								<tr><td>2</td><td>PENGUASAAN MATERI<br>(Ketepatan Menjawab Pertanyaan)</td></tr>
								<tr><td>3</td><td>KEMAMPUAN PRESENTASI<br>(Komunikasi, Pengendalian Waktu, Penyajian, Kejujuran)</td></tr>
							</table>
						</td></tr>
						<tr><td colspan=\"3\" align=\"center\"><table cellspacing=\"0\"><tr><td width=\"150\" height=\"75\" style=\"border:solid;border-width:thick;vertical-align:middle\" align=\"center\"><h3>Nilai huruf :</h3></td><td width=\"100\" height=\"75\" style=\"border:solid;border-width:thick\">&nbsp;</td></tr></table></td></tr>
						<tr><td>&nbsp;</td></tr>
