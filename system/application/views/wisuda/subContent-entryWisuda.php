<div id="contentSub"><div id='mw-revisiontag' class='flaggedrevs_short plainlinks noprint'>
    <table border='0' cellspacing='0' style='background: none;'>
        <tr style='white-space:nowrap;'><td>
            ...
            <b><a class="thickbox" title='<b>ENTRY PERIODE WISUDA</b>' href="<?php echo site_url("wisuda/entryWisuda?TB_inline=true&height=115&width=640&inlineId=entry_Wisuda&modal=false")?>">Entri Wisuda</a></b>
        </td></tr>
    </table>
</div></div>
