...
$(document).ready(function(){
    populateElement("#search", "Masukkan Nama Dosen di sini...");
})


</script>

<form class="lable-overley-2" id="global-search-form" action="<?php echo site_url('kbk/cariDosen');?>" method="post" style="display: inline;float: left;padding: 0 1em 0 0;">
<!--    <label for="search" >Pencarian</label>-->
Cari Dosen : <input type="text" name="search" value="" id="search" onchange="CariNama()" style="height: 15px; width: 150px;"/>
